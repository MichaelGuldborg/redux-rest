...
import {OptionalIdentifiable} from '../models/Identifyable';
...
export const crudValueRestActions = <T extends OptionalIdentifiable>(stateName: string, service: CrudPropertyServiceType<T>): CrudValueRestActionType<T> => {
    return {
